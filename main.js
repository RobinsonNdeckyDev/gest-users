...
const { addUser, getUsers, updateUser, deleteUser } = require("./database");
...
ipcMain.handle(
  "add-user",
  async (event, prenom, nom, email, adresse, profession) => {
...
ipcMain.handle(
  "update-user",
  async (event, id, prenom, nom, email, adresse, profession) => {
